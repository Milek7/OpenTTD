 ...
 */
void Window::SetWidgetHighlight(uint widget_index, TextColour highlighted_colour)
{
 ...
 */
bool Window::IsWidgetHighlighted(uint widget_index) const
{
	assert(widget_index < this->nested_array_size);
 ...
 */
void Window::SetWidgetDirty(uint widget_index) const
{
 ...
 */
void Window::HandleButtonClick(uint widget)
{
 ...
 */
void SetWindowWidgetDirty(WindowClass cls, WindowNumber number, uint widget_index)
{
	const Window *w;
	FOR_ALL_WINDOWS_FROM_BACK(w) {

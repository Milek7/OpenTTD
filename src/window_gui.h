...
public:
	...
	void SetWidgetHighlight(uint widget_index, TextColour highlighted_colour);
	bool IsWidgetHighlighted(uint widget_index) const;
	 ...
	 */
	inline void SetWidgetDisabledState(uint widget_index, bool disab_stat)
	{
	 ...
	 * @param widget_index index of this widget in the window
	 */
	inline void DisableWidget(uint widget_index)
	{
	 ...
	 * @param widget_index index of this widget in the window
	 */
	inline void EnableWidget(uint widget_index)
	{
	 ...
	 */
	inline bool IsWidgetDisabled(uint widget_index) const
	{
		assert(widget_index < this->nested_array_size);
	 ...
	 */
	inline bool IsWidgetGloballyFocused(uint widget_index) const
	{
	 ...
	 */
	inline void SetWidgetLoweredState(uint widget_index, bool lowered_stat)
	{
		assert(widget_index < this->nested_array_size);
	 ...
	 * @param widget_index index of this widget in the window
	 */
	inline void ToggleWidgetLoweredState(uint widget_index)
	{
		assert(widget_index < this->nested_array_size);
	 ...
	 * @param widget_index index of this widget in the window
	 */
	inline void LowerWidget(uint widget_index)
	{
	 ...
	 * @param widget_index index of this widget in the window
	 */
	inline void RaiseWidget(uint widget_index)
	{
	 ...
	 */
	inline bool IsWidgetLowered(uint widget_index) const
	{
		assert(widget_index < this->nested_array_size);
	...
	void HandleButtonClick(uint widget);
	int GetRowFromWidget(int clickpos, int widget, int padding, int line_height = -1) const;

	void RaiseButtons(bool autoraise = false);
	void CDECL SetWidgetsDisabledState(bool disab_stat, int widgets, ...);
	void CDECL SetWidgetsLoweredState(bool lowered_stat, int widgets, ...);
	void SetWidgetDirty(uint widget_index) const;

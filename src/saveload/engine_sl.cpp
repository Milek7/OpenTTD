...
static const SaveLoad _engine_desc[] = {
	...
	SLE_CONDNULL(1,                                                        SL_MIN_VERSION, SLV_179), // old preview_company_rank
	 SLE_CONDVAR(Engine, preview_asked.data[0], SLE_FILE_U16 | SLE_VAR_U64,  SLV_179, SLV_MORE_COMPANIES),
	...
	SLE_CONDNULL(1,                                                        SL_MIN_VERSION,  SLV_45),
	 ...
	 SLE_CONDVAR(Engine, company_avail.data[0],  SLE_FILE_U16 | SLE_VAR_U64,  SLV_104, SLV_MORE_COMPANIES),
	 SLE_CONDARR(Engine, company_avail.data,     SLE_UINT64, CompanyMask::bsize, SLV_MORE_COMPANIES, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, company_hidden.data[0], SLE_FILE_U16 | SLE_VAR_U64,  SLV_193, SLV_MORE_COMPANIES),

...
static const SaveLoad _town_desc[] = {
	...
	SLE_CONDVAR(Town, statues.data[0],       SLE_FILE_U16 | SLE_VAR_U64, SLV_104, SLV_MORE_COMPANIES),
	...
	SLE_CONDVAR(Town, have_ratings.data[0],  SLE_FILE_U16 | SLE_VAR_U64, SLV_104, SLV_MORE_COMPANIES),
